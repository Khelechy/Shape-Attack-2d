...
public class ShareAndRate : MonoBehaviour
{
	...
	string subject = "Shape Attack 2D";
	string body = "Hey, have you played Shape Attack 2D? No? you are missing a lot, join lot of gamers trying to gather coins to buy the sheild for protection from the shapes. Download from the Google Play Store: https://test.playstore.com/rona";
